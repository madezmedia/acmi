...
2. Set your environment variables:
   ...
   ```
3. Make the script executable: `chmod +x ~/.openclaw/skills/acmi/cli/acmi.mjs`
...
```bash
node ~/.openclaw/skills/acmi/cli/acmi.mjs profile "sales" "gardine-wilson" '{"name": "Gardine Wilson", "company": "ClientCo", "stage": "Proposal Sent"}'
```
...
node ~/.openclaw/skills/acmi/cli/acmi.mjs event "sales" "gardine-wilson" "gmail" "Sent the PDF proposal."
```
...
```bash
node ~/.openclaw/skills/acmi/cli/acmi.mjs signal "sales" "gardine-wilson" '{"churn_risk": "low", "next_action": "Follow up Friday", "sentiment": "positive"}'
```
...
```bash
node ~/.openclaw/skills/acmi/cli/acmi.mjs get "sales" "gardine-wilson"
```

### 5. List Entities in a Namespace
```bash
node ~/.openclaw/skills/acmi/cli/acmi.mjs list "sales"
```

### 6. Delete Entity Context
```bash
node ~/.openclaw/skills/acmi/cli/acmi.mjs delete "sales" "gardine-wilson"
```
